...
class Template(object):
	...
	def procesar_img(self, msg):
		#Se cambia el espacio de color y se definen variables
		bridge=CvBridge()
		...
		# Definir blobs
                ...
                #Se dibujan contornos alrededor del blob detectado 
                for cnt in contours:    
                  x,y,w,h=cv2.boundingRect(cnt)
                  
                  #Se define una distancia arbitraria para el eje z"""""
		...
		#Distancia a la que se dibuja el contorno 
